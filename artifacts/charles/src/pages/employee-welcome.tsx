...
export default function EmployeeWelcome() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#f0ede8] overflow-hidden relative px-6 py-14">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 opacity-70">
        <svg viewBox="0 0 1440 220" className="w-full h-36 sm:h-40" preserveAspectRatio="none">
          <path
      ...
      >
        ...
        <motion.div
          ...
          className="mt-9"
        >
          <h1 className="font-serif text-[38px] sm:text-[48px] leading-[1.03] tracking-[-0.02em] text-[#1f3a2b]">
            {greeting}, {firstName}.
            <br />
            Take a breath before you begin.
          </h1>
          <p className="mt-5 font-serif text-[15px] sm:text-[16px] leading-relaxed text-[#7a8b7e]">
        ...
        >
          {/* Decorative leaves */}
          <Leaf className="absolute -left-10 -top-5 w-5 h-5 text-[#4a7c59]/14 rotate-12" />
          <Leaf className="absolute -right-10 -top-3 w-4 h-4 text-[#4a7c59]/12 -rotate-6" />
          <Leaf className="absolute -left-12 bottom-6 w-4 h-4 text-[#4a7c59]/10 rotate-[-14deg]" />

          <div className="absolute inset-0 -z-10 blur-3xl rounded-full bg-[#4a7c59]/10 scale-110" />
          <div className="absolute left-1/2 -translate-x-1/2 bottom-1 w-56 h-10 rounded-full blur-2xl bg-black/10 -z-10" />
          <Bonsai
            src={welcomeBonsai}
        ...
        >
          <motion.button
            ...
            className="w-full max-w-sm h-14 rounded-full bg-[#4a7c59] text-white text-[15px] font-semibold tracking-wide hover:bg-[#3d6b4a] transition-colors shadow-[0_16px_44px_rgba(74,124,89,0.24)]"
          >
            Begin Check-in
          </motion.button>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-center gap-8">
            {[
              ...
              <div key={label} className="flex flex-col items-center">
                <div className="w-11 h-11 rounded-full bg-[#dfe7db] text-[#4a7c59] flex items-center justify-center shadow-[0_10px_28px_rgba(0,0,0,0.06)]">
                  <Icon className="w-5 h-5" />
                </div>
                <div className="mt-3 text-[11px] tracking-[0.28em] uppercase text-[#6b7280] font-medium">
                  {label}
                </div>
              </div>
            ))}
          ...
          <div className="mt-7 text-[11px] tracking-[0.34em] uppercase text-[#6b7280]/85">
            ROOTED. CALM. FOCUSED.
          </div>
        </motion.div>
